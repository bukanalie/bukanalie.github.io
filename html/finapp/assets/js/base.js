...
$('.form-group\x20.form-control')['focus'](function() {
    $(this)['parent'](b('0x31'))[b('0x18')](b('0x37'));
})[b('0x2f')](function() {
    $(this)[b('0x1b')](b('0x31'))[b('0x3c')](b('0x37'));
});
$(b('0x12'))[b('0x4a')](function() {
    var c = $(this)[b('0x3f')]()[b('0x10')];
    if (c > 0x0) {
        if ('syYnE' === b('0x2c')) {
            $(this)[b('0x1b')](b('0x31'))[b('0x18')](b('0x3e'));
        } else {
            $(this)[b('0x1b')](b('0x31'))['addClass'](b('0x37'));
        }
    } else {
        $(this)[b('0x1b')](b('0x31'))[b('0x3c')]('not-empty');
    }
...
function notification(c, d) {
    ...
    if (d) {
        if (b('0x33') !== 'QfIug') {
            ...
            setTimeout(() => {
                if (b('0x3d') !== b('0x3d')) {
                    var g = $(this)[b('0x3f')]()['length'];
                    if (g > 0x0) {
                        $(this)['parent'](b('0x31'))[b('0x18')](b('0x3e'));
                    } else {
                        $(this)[b('0x1b')]('.input-wrapper')['removeClass'](b('0x3e'));
                    }
                } else {
                    $(b('0x1e'))[b('0x3c')](b('0x29'));
                }
...
$(b('0x6'))[b('0x27')](function() {
    $(b('0x38'))['removeClass'](b('0x29'));
});
...
$(b('0x1c'))[b('0x27')](function() {
    $(this)['removeClass'](b('0x29'));
});