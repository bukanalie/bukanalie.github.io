...
!function boot(modules, config, bootModule) {
    ...
    18: [function (callback, e, n) {
        callback("19"), window._ = callback("34"), Number.prototype.lerp = function (t, e) {
    ...
    53: [function (callback, exportObject, exportField) {
        function r(t, e, n, r) {
        ...
        callback("18"), callback("28").polyfill();
        var o = callback("3"), a = callback("14"), s = callback("15"), c = callback("17"), u = callback("43"), l = callback("50"), f = callback("44"), h = callback("51");
        $("canvas");
